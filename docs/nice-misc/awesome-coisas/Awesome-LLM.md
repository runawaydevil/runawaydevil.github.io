...
- [Chain-of-Thoughts Papers](https://github.com/Timothyxxx/Chain-of-ThoughtsPapers) - Uma tendência começa a partir de "Chain of Thought Prompting Elicits Reasoning in Large Language Models".
...
- [Instruction-Tuning-Papers](https://github.com/SinclairCoder/Instruction-Tuning-Papers) - Uma tendência começa a partir de `Natural-Instruction` (ACL 2022), `FLAN` (ICLR 2022) e `T0` (ICLR 2022).
...
- [https://github.com/FranxYao/chain-of-thought-hub](https://github.com/FranxYao/chain-of-thought-hub) - Medindo o desempenho de raciocínio dos LLMs
...
- [Awesome LLM Human Preference Datasets](https://github.com/PolisAI/awesome-llm-human-preference-datasets) - uma coleção de conjuntos de dados de preferência humana para ajuste de instrução LLM, RLHF e avaliação.
...
- [https://github.com/llm-jp/awesome-japanês-llm](https://github.com/llm-jp/awesome-japanês-llm) - 日本語LLM
...
<details>
<summary> outras tabelas de classificação </summary>
...
- [https://rank.opencompass.org.cn](https://rank.opencompass.org.cn) - O CompassRank dedica-se a explorar os modelos de linguagem e visual mais avançados, oferecendo uma referência de avaliação abrangente, objetiva e neutra para a indústria e pesquisa.
...
<details>
<summary>IA de estabilidade</summary>
...
<details>
<summary>Laboratório de IA de Shanghai</summary>
...
- [https://github.com/DataEval/dingo](https://github.com/DataEval/dingo) - Dingo: Uma ferramenta abrangente de avaliação da qualidade dos dados
...
<details>
<summary>outros quadros de avaliação</summary>
...
<details>
<summary>outros quadros</summary>
...
- [https://github.com/pytorch/torchtune](https://github.com/pytorch/torchtune) - Uma biblioteca nativa-porro para LLM Afinação.
...
- [NVIDIA FasterTransformer](https://github.com/NVIDIA/FasterTransformer) - NVIDIA Framework for LLM Inference (Transicionado para TensorRT-LLM)
- [MInference](https://github.com/microsoft/MInference) Para acelerar a inferência de Long-context LLMs, esparso aproximado e dinâmico calcular a atenção, o que reduz a latência de inferência em até 10x para pré-preenchimento em um A100, mantendo a precisão.
...
- [langchain](https://github.com/hwchase17/langchain) Uma biblioteca popular Python/JavaScript para sequências de encadeamento de prompts de modelos de linguagem.
...
- [swiss_army_llama](https://github.com/Dicklesworthstone/swiss_army_llama) - Conjunto abrangente de ferramentas para trabalhar com LLMs locais para várias tarefas.
- [LiteChain](https://github.com/rogeriochaves/litechain) - Alternativa leve a LangChain para compor LLMs
- [magentic](https://github.com/jackmpcollins/magentic) - Integrar LLMs como funções Python
...
- [https://github.com/nilsherzig/LLocalSearch](https://github.com/nilsherzig/LLocalSearch) - Rodando localmente Websearch usando cadeias LLM

- [https://github.com/Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) - O quê? Gateway simplifica solicitações para 100+ modelos de código aberto e fechado com uma API unificada. Ele também está pronto para a produção com suporte para caching, fallbacks, retries, timeouts, loadebalancing, e pode ser desempregada para latência mínima.
...
- [https://github.com/langfuse/langfuse](https://github.com/langfuse/langfuse) - Open Source LLM Engineering Platform - Rastreamento, Avaliações, Gestão de Prompts, Avaliações e Playground.
...
- [https://docs.chainlit.io/overview](https://docs.chainlit.io/overview) -- Uma biblioteca Python para fazer interfaces chatbot.
...
- [https://github.com/hegelai/prompttools](https://github.com/hegelai/prompttools) - O quê? Ferramentas Python de código aberto para testar e avaliar modelos, DBs vetoriais e prompts.
- [https://github.com/normal-computing/outlines](https://github.com/normal-computing/outlines) Uma biblioteca Python que fornece uma linguagem específica de domínio para simplificar a geração de pedidos e restrições.
...
- [https://promptperfect.jina.ai/prompts](https://promptperfect.jina.ai/prompts) - O quê? Um produto pago para testar e melhorar alertas.
- [https://wandb.ai/site/solutions/llmops](https://wandb.ai/site/solutions/llmops) - O quê? Um produto pago para treinamento de modelo de rastreamento e experimentos de engenharia rápida.
- [https://github.com/openai/evals](https://github.com/openai/evals) - O quê? Uma biblioteca de código aberto para avaliar o desempenho de tarefas de modelos de linguagem e prompts.

- [https://www.arthur.ai/get-started](https://www.arthur.ai/get-started) - O quê? Um produto pago para detectar toxicidade, alucinações, injecção rápida, etc.
...
- [https://www.manning.com/books/build-a-large-large-language-model-of-scratch](https://www.manning.com/books/build-a-large-large-language-model-of-scratch) - Um guia para construir a sua própria LLM.
...
- [https://www.notion.so/Awesome-LLM-40c8aa3f2b444ecc82b79ae8bbd2696b](https://www.notion.so/Awesome-LLM-40c8aa3f2b444ecc82b79ae8bbd2696b)
- [https://research.aimultiple.com/large-lange-model-training/](https://research.aimultiple.com/large-lange-model-training/)
...
- [https://docs.google.com/spreadsheets/d/1bmpDdLZxvTCleLGVPgzoMTQ0iDP2-7v7QziPrzPdHyM/edit#gid=0](https://docs.google.com/spreadsheets/d/1bmpDdLZxvTCleLGVPgzoMTQ0iDP2-7v7QziPrzPdHyM/edit#gid=0)
...
- [https://www.cursor.so](https://www.cursor.so) - Escreva, edite e converse sobre seu código com uma poderosa IA.
