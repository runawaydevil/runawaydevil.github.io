...
(http://thestocks.im/) "As melhores fotos de estoque grátis são entregues agora, juntamente com vídeos, áudios, ícones, fontes e cores."
...
- [Gratisografia] (http://www.gratisography.com/) "A coleção mais peculiar do mundo de imagens de alta resolução."
...
- [Startup Fotos stock] (http://startupstockphotos.com/) Fotos gratuitas para startups, blogueiros, editores, sites, designers, desenvolvedores, criadores,
- Todos os outros.
...
(http://realisticshots.com/) Fotos gratuitas (alta resolução) para uso pessoal e comercial. 7 novas fotos todas as semanas.
...
- [LIBRESHOT](https://libreshot.com/) Livre arte fina e fotografia comum. Imagens gratuitas para blogs ou sites, mesmo para uso comercial.
Não há necessidade de mencionar o autor.
(https://barnimages.com/) Imagens de alta resolução gratuitas para todos.
...
(https://uifaces.co/) UI Faces agrega milhares de avatares que você pode filtrar cuidadosamente para criar suas personas perfeitas ou apenas gerar avatares aleatórios.

# # Cor

(https://coolores.co/) O gerador de esquemas de cores super rápido!
- [Colordot](https://color.hailpixel.com/)

(https://brandcolors.net/) A maior coleção de códigos oficiais de cores de marcas ao redor.
- [Paleta de desenho material](https://www.materialpalette.com/)
- [Flat UI Color Picker](http://www.flatuicolorpicker.com/)
(https://www.webdesignrankings.com/resources/lolcolors/) Inspiração de paletas coloridas.
...
(https://colorable.jxnblk.com/) "Se alguém diz 'Vermelho' (o nome da cor) e há 50 pessoas ouvindo, pode-se esperar que haja 50 vermelhos em suas mentes. E podemos ter certeza de que todos esses vermelhos serão muito diferentes." - Josef Albers
(https://material.io/guidelines/style/color.html) O sistema de cores Material Design pode ser usado para criar um tema de cor que reflete sua marca ou estilo.
...
- (http://zhongguose.com) é uma coleção de cores tradicionais chinesas.
...
(https://octicons.github.com/) Ícones do GitHub.
...
(http://fontewesome.io/) Obtenha ícones vetoriais e logotipos sociais em seu site com o Font Awesome, o conjunto de ícones mais popular da web e kit de ferramentas. □
...
(http://coreui.io/icons/) Icone gratuito projetado Premium definido com marcas em SVG, Webfont e formatos raster.

# # Tipografia

- [tipografia](https://www.typography.com/)
- [Eu amo tipografia](http://ilovetypography.com/) foi criado em 7 de agosto de 2007. Ele existe porque tenho uma paixão por tipografia, design de tipos e letras, além das páginas, palavras e cartas que surgem dessas disciplinas. (https://www.typesbeautiful.com/) O que é isso?
...
(https://fonts.adobe.com/fonts) Desfrute de navegação rápida, fácil uso em aplicativos de desktop ou na web, e inspiração tipográfica infinita.
- [Google Fonts](https://fonts.google.com/)
(https://femmebot.github.io/google-type/)
(http://blog.justfont.com/) O que é isso?
...
- [Adobe Photoshop](http://www.adobe.com/products/photoshop.html) É o melhor aplicativo de imagem e design, central em quase todos os projetos criativos. [PSD Repo](https://psdrepo.com/), [PSDDD](https://psdd.co/). □
...
(https://bootstrapstudio.io/) Um aplicativo de desktop poderoso para criar sites responsivos usando o framework Bootstrap.
...
(https://modao.cc/) Ferramenta móvel de prototipagem sem dor de cabeça.
...
- [360 Mockups](https://360mockups.com/) é totalmente GRÁTIS para baixar PSD Mockups e apresentar seus trabalhos.
  (http://facebook.design/dispositivos) Imagens e arquivos Sketch de dispositivos populares.
  (http://facebook.design/handskit) Fotos de mãos segurando vários telefones, que podem ser usadas em qualquer apresentação de seus projetos.
...
- [NinjaMock](https://ninjamock.com/) é uma pequena startup com sede na Dinamarca, um país famoso pela sua forte atitude em relação ao design e à qualidade.
  (https://smartmockups.com/) A ferramenta #1 para criar imagens de marketing impressionantes.
...
(https://lookback.io/) Capture exatamente como os usuários experimentam seu produto: não é necessário adivinhar.
...
(http://www.airsquirrels.com/reflector/) Espelho sem fio e receptor de streaming.
...
(https://validately.com/) Fácil maneira de recrutar testadores, lançar testes e analisar resultados.
(http://userssthink.com/) Obtenha feedback do usuário de pessoas reais, sob demanda, quando você precisar.
...
- [Facebook Design on Medium](https://medium.com/facebook-design) experiências das pessoas que projetam produtos bilhões de pessoas usam todos os dias.
...
(https://medium.muz.li/) Os links mais frescos sobre design e interativo, de toda a web.
...
(https://httpster.net/)
(http://emptystat.es/)
- [Chamada à Ideia](http://www.calltoidea.com/)
(https://siiiimple.com/)
...
- [1stwebdesigner](https://1stwebdesigner.com) Por profissionais de web design, para profissionais de web design. Estamos numa missão para ajudá-lo a construir uma rede melhor.
(https://www.webpagefx.com/tools/emoji-cheat-sheet/)
- [EMOJI CSS](https://afeld.github.io/emoji-css/?ref=webdesignernews.com)
- [DesignShock](https://www.designshock.com/) é o maior pacote/assinatura que você pode encontrar em um lugar, incluindo ícones, avatares, elementos gráficos, GUI packs, conjuntos de design e tanto web e modelos de impressão
- [SVG PORN](http://www.svgporn.com/)
- [Up](https://www.uplabs.com/) é a principal comunidade de criativos, oferecendo todos os dias os melhores recursos para download.
(http://freebble.com/)
- [Baianat](https://www.baianat.com/resources/)
- [Graphberry](http://www.graphberry.com/) fornecer-lhe os recursos gráficos criativos que você precisa para transformar em seu trabalho pessoal ou comercial.
- [UX Project Checklist] (http://uxchecklist.github.io/) □
- [TRIDIV](http://tridiv.com/) é um editor baseado na web para criar formas 3D em CSS.
- [Mobile Mozaic] (http://www.mobilemozaic.com/)
- [wwwhere](http://wwwhere.io/)
- [Lapa](http://www.lapa.ninja/) é uma galeria com os melhores exemplos de landing pages de 1920 em toda a web.
- [Designer Mill](https://www.designermill.com/)
(http://freebiesjedi.com)
(https://webfieldmanual.com/)
(https://uxtools.co/)
- [CodeMyUI] (https://codemyui.com/) Web Design & UI Inspiração com Excertos de Código.
- [A List Apart](https://alistapart.com/) tem vindo a discutir o design, desenvolvimento e significado de conteúdos web desde 1997 e continua a ser um grande recurso para designers e programadores.

# # Guia de estilo e Branding

Claro! Aqui está o texto reescrito em português brasileiro, mantendo as formatações e links intactos:

(https://saijogeorge.com/brand-style-guide-exemplos/)
- [Mozilla](https://www.mozilla.org/pt-BR/styleguide/)
(http://ux.mailchimp.com/patterns/)
- [Planeta Solitário](http://rizzo.lonelyplanet.com/styleguide/design-elements/colors)
...
- [Canal4](http://styleguides.canal4.com/E4_StyleGuide.pdf)
- [Twitter] (https://brand.twitter.com/)
- [Nike Pro](http://manualcreative.com/project/nike-pro-services/)
- [Médio](https://www.behance.net/gallery/7226653/Medium-Brand-Desenvolvimento)
- [Linkedin](https://brand.linkedin.com/)
- [Vermelho](http://www.redcross.org/images/MEDIA_CustomProductCatalog/m6440103_BrandPoster.pdf)
...
(https://www.amazon.com/gp/product/1118766571/ref=as_li_qf_sp_asin_il_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=1118766571&linkCode=as2&tag=office03a70-20&linkId=I5TMKUXH43SHHPE)
...
- [Creativeadawards.com/) Descubra as campanhas de publicidade mais criativas e sofisticadas ao redor do mundo.
...
- [Creativemannings.com/) é uma série de palestras para a comunidade criativa.
