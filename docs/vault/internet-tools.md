# 🧰 Ferramentas de Internet e Rede
...
- [AdGuard](https://adguard-d

---

## Extensões e Ferramentas para Navegadores

- 🌐 **[Índices de Extensões Open-Source](https://webextension.org/)** ou [MyBrowserAddon](https://mybrowseraddon.com/) - Repositórios de extensões de código aberto.
- ⭐ **[Dark Reader](https://darkreader.org/)**, [Midnight Lizard](https://midnight-lizard.org/) ou [Custom Dark Mode](https://mybrowseraddon.com/custom-dark-mode.html) - Modo escuro para sites.
- ⭐ **[Auto Tab Discard](https://add0n.com/tab-discard.html)** ou [Tab Wrangler](https://github.com/tabwrangler/tabwrangler) - Descarte guias inativas para economizar recursos.
- ⭐ **[Clipboard2File](https://github.com/fmhy/FMHY/wiki/FMHY%E2%80%90Notes.md#clipboard2file-addons)** - Faça upload de imagens da área de transferência.
- [CRX Viewer](https://robwu.nl/crxviewer/) - Visualize o código-fonte de extensões.
- [Vimium](https://vimium.github.io/) - Atalhos de teclado para navegação.
- [Custom Scrollbars](https://addons.wesleybranton.com/addon/custom-scrollbars/) - Barras de rolagem personalizadas para o navegador.
- [User Agent Switcher](https://webextension.org/listing/useragent-switcher.html) - Altere o agente do usuário do navegador.
- [SingleFile](https://github.com/gildas-lormeau/SingleFile) - Salve páginas da web como HTML.
- [Stylus](https://add0n.com/stylus.html) - Esquemas de cores personalizados para sites.
...
- [CapFrameX](https://github.com/CXWorld/CapFrameX?tab=readme-ov-file) - Capture o framerate durante o gameplay.
- [Ludusavi](https://github.com/mtkennerly/ludusavi) - Ferramenta para backup de dados salvos de videogames para PC.
- [ProtonDB](https://www.protondb.com/) - Banco de relatórios de compatibilidade de jogos com Linux.
- [SteamDB](https://steamdb.info/extension/) - Informações detalhadas sobre jogos e DLCs no Steam.

## Ferramentas Diversas

- [Debrid Media Manager](https://github.com/debridmediamanager/debrid-media-manager?tab=readme-ov-file) - Gerencie arquivos em cache no Real Debrid.
- [SlideSaver](https://slidesaver.app/) - Baixe apresentações do SlideShare.
- [Unddit](https://undelete.pullpush.io/) - Visualize posts removidos do Reddit.
- [Clonezilla](https://clonezilla.org/) - Crie pontos de restauração de imagens ISO.
- [Addic7ed-com](http://www.addic7ed.com/) - Legendas multilíngues para filmes e séries.

## Extensões e Ferramentas para Firefox

- 🌐 **[Firefox Addons](https://addons.mozilla.org/en-US/firefox/extensions/)** - Loja de extensões para Firefox.
- ⭐ **[FoxyTab](https://addons.mozilla.org/en-US/firefox/addon/foxytab/)** - Ferramentas para gerenciamento de abas.
- [Firefox Containers](https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/) - Separe sessões no Firefox para maior privacidade.

## Extensões e Ferramentas para Chrome

- 🌐 **[Chrome Web Store](https://chromewebstore.google.com/)** - Loja de extensões para Chrome.
- ⭐ **[Extensity](https://chromewebstore.google.com/detail/extensity/jjmflmamggggndanpgfnpelongoepncg)** - Gerencie suas extensões de forma eficiente.
- [Smart Mute](https://chromewebstore.google.com/detail/smart-mute/apadglapdamclpaedknbefnbcajfebgh) - Gerencie o áudio das abas no Chrome.

## Extensões e Ferramentas para Safari

- [Userscripts](https://apps.apple.com/us/app/userscripts/id1463298887) - Gerenciador de Userscripts para Safari.
- [Night Eye](https://apps.apple.com/app/dark-mode-for-safari-nighteye/id1450504903) - Modo escuro para Safari.

## Userscripts

- ⭐ **[Violentmonkey](https://violentmonkey.github.io/)**, **[Tampermonkey](https://www.tampermonkey.net/)** - Gerenciadores de Userscripts.
- ⭐ **[Greasy Fork](https://greasyfork.org/)** - Instale e gerencie Userscripts.

## Archiving

- ⭐ **[Internet Archive](https://archive.org/)** - Arquive páginas da web e outros conteúdos digitais.
- ⭐ **[Wayback Machine](https://web.archive.org/)** - Ferramenta para arquivar e acessar versões antigas de páginas da web.

## Web Scraping / Crawling

- 🌐 **[Awesome Web Scraping](https://github.com/lorien/awesome-web-scraping)** - Recursos e ferramentas para raspagem de dados na web.
- [Heritrix](https://heritrix.readthedocs.io/) - Crawler da Internet Archive.

## Open Source Intelligence

- 🌐 **[Awesome OSINT](https://github.com/jivoi/awesome-osint)** - Recursos e ferramentas para inteligência de fontes abertas (OSINT).
- ⭐ **[IntelTechniques](https://inteltechniques.com/index.html)** - Recursos para técnicas de OSINT.

Este documento consolidado oferece uma visão abrangente das ferramentas e extensões disponíveis para melhorar a experiência online, desde navegação e jogos até segurança e arquivamento.
